pen__version__ = "$Revision: 499 $, $Date: 2013-04-15 15:50:05 +0200 (ma, 15 apr 2013) $, $Author: quintijn $"
...
import time
# hopelijk: QH
from natlinkutilsqh import getUserDirectory, AppBringUp
baseDirectory = getUserDirectory()
...
def test_natspeak_on():
    ...
    result = SelectFromListDialog(["foo","bar"], ["title 1", "title 2"], defer=0)
    

if __name__=='__main__':
    print test_natspeak_on()
